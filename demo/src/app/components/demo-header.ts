...
let components = [
  {name: 'Bubble Chart', href: 'bubbleChart'}
];
  ...
  template: `
    ...
    <div class="container">
      <div class="navbar-header hidden-md-up">
        ...
        <a class="navbar-brand visible-xs" href="{{prefix}}#">ng2-vizabi</a>
      </div>
      <nav class="hidden-xs hidden-xs-down">
        <ul class="nav navbar-nav">
          <li class="nav-item"><a href="{{prefix}}#top" role="button" class="navbar-brand">ng2-vizabi</a></li>
